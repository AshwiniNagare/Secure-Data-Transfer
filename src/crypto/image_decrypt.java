 ...
 * @author HP
 */
public class image_decrypt extends javax.swing.JFrame {

    /**
     * Creates new form decrypt
     */
    public image_decrypt() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(image_decrypt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new image_decrypt().setVisible(true);
            }
        });
    }

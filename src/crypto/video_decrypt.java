 ...
 * @author HP
 */
public class video_decrypt extends javax.swing.JFrame {

    
    public video_decrypt() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
		...
		SecretKey dkey = new SecretKeySpec(ekey, 0, ekey.length, "AES");
                byte[] encodedKey=key1.getText().getBytes();                       
			...
			c.init(Cipher.DECRYPT_MODE, originalKey, parameterSpec); // Encrypt the video
            ...
            outStream.flush();
            cos.close();
            JOptionPane.showMessageDialog(null, "The video file decrypted successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(video_decrypt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new video_decrypt().setVisible(true);
            }
        });
    }
